...
<table style="font-family:'Open Sans',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div class="v-text-align" style="color: #7a7676; line-height: 170%; text-align: left; word-wrap: break-word;">
    <p dir="rtl" style="font-size: 14px; line-height: 170%; text-align: right;"><span style="font-size: 16px; line-height: 27.2px;">مرحبا {{$data['name']}}<br />{!!$data['message']!!}<br />مع تحيات فريق الساورة دليفري. </span></p>
  </div>
