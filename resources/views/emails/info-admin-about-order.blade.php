...
<table style="font-family:'Open Sans',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div class="v-text-align" style="color: #47484b; line-height: 140%; text-align: center; word-wrap: break-word;">
    <p dir="rtl" style="font-size: 14px; line-height: 140%;"><span style="font-size: 24px; line-height: 33.6px;"><strong><span style="line-height: 33.6px; font-size: 24px;">إدارة الساورة دليفري</span></strong></span></p>
  </div>
...
<table style="font-family:'Open Sans',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div class="v-text-align" style="color: #7a7676; line-height: 170%; text-align: left; word-wrap: break-word;">
    <p dir="rtl" style="font-size: 14px; line-height: 170%; text-align: right;"><span style="font-size: 16px; line-height: 27.2px;">مرحبا {{$data['name']}}<br />لديك طلب جديد عليك الإطلاع على الموقع والتعامل معه.<br /><a href="{{route('admin.order.details',$data['order_id'])}}" target="_blank">مشاهدة الطلب</a></span></p>
  </div>
