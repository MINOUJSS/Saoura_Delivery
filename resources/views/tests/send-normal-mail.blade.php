            ...
            <div id="main" class="col-md-9">
                ...
                <!-- DASHBOARD -->
                    <div class="row" style="direction: ltr !important"> 
                        <a href="{{route('test.send.cron.job.email')}}" class="btn btn-primary">switch to corn job mail form</a>
                        <h1>Test Send Normal Mail</h1>                                           
                        <!---->
                        <form class="review-form" method="POST" action="{{ route('test.send.normal.email.send') }}">
                            @csrf
