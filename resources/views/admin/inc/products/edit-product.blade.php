      ...
      <div class="container-fliud">
        ...
        <div classe="form-group">
          <select class="form-control" name="is_new">
              <option value="1" @if($product->is_new==1 || old('is_new')===1){{'selected'}}@endif>جديد</option>
              <option value="0" @if($product->is_new==0 || old('is_new')===0){{'selected'}}@endif>مستعمل</option>
          </select>
        </div>
