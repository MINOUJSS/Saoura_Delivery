<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        تعديل لون للمنتج
        <small>تعديل لون للمنتج رقم:{{$product->id}}</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="{{route('admin.products')}}"><i class="fa fa-gift"></i> المنتجات</a></li>
        <li class="active">تعديل لون للمنتج</li>
      </ol>
    </section>
              ...
              <!--end daitels-->
                ...
                <div class="col-lg-6">
                    <div class="box box-primary">
                        ...
                        <!-- form start -->
                        <form role="form" action="{{route('admin.edit-color-to-product.update')}}" method="POST" enctype="multipart/form-data">
                          @csrf
                          <input type="hidden" name="product_color_id" value="{{$prod_color->id}}">
                          ...
                          <div class="box-body">
                            <div class="form-group">
                              ...
                              <select name="color_id" class="form-control">
                                ...
                                <option value="{{$color->id}}" @if(old('color_id')==$color->name || $prod_color->color->name==$color->name){{'selected'}}@endif>{{$color->name}}</option>
                                @endforeach
                              </select>
                            </div>
                            <div class="form-group">
                              <label for="qty">عدد المنتجات للون المختار</label>
                              <input type="number" class="form-control" name="qty" id="qty" value="@if(old('qty')){{old('qty')}}@else{{$prod_color->qty}}@endif">                              
                            </div>                            
                            <div class="form-group">
