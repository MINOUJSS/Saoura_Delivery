<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        إضافة فيديو للمنتج
        <small>إضافة فيديو للمنتج رقم:{{$product->id}}</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="{{route('admin.products')}}"><i class="fa fa-gift"></i> المنتجات</a></li>
        <li class="active">إضافة فيديو للمنتج</li>
      </ol>
    </section>
              ...
              <!--end daitels-->
                ...
                <div class="col-lg-6">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                          <h3 class="box-title">إضافة فيديو</h3>
                        </div><!-- /.box-header -->
                        <!-- form start -->
                        <form role="form" action="{{route('admin.add-video-to-product.store')}}" method="POST" enctype="multipart/form-data">
                          @csrf
