<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        إضافة صور للمنتج
        <small>إضافة صور للمنتج رقم:{{$product->id}}</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="{{route('admin.products')}}"><i class="fa fa-gift"></i> المنتجات</a></li>
        <li class="active">إضافة صور للمنتج</li>
      </ol>
    </section>
              ...
              <!--end daitels-->
                ...
                <div class="col-lg-6">
                    <div class="box box-primary">
                        ...
                        <!-- form start -->
                        <form role="form" action="{{route('admin.add-image-to-product.store')}}" method="POST" enctype="multipart/form-data">
                          @csrf
