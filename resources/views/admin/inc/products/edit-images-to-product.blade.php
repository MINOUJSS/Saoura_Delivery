<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        تعديل صور للمنتج
        <small>تعديل صور للمنتج رقم:{{$product->id}}</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="{{route('admin.products')}}"><i class="fa fa-gift"></i> المنتجات</a></li>
        <li class="active">تعديل صور للمنتج</li>
      </ol>
    </section>
              ...
              <!--end daitels-->
                ...
                <div class="col-lg-6">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                          <h3 class="box-title">إضافة صورة</h3>
                        </div><!-- /.box-header -->
                        <!-- form start -->
                        <form role="form" action="{{route('admin.edit-image-to-product.update')}}" method="POST" enctype="multipart/form-data">
                          @csrf
                          <input type="hidden" name="product_image_id" value="{{$prod_image->id}}">
                      ...
                      <div class="box">
                        <div class="box-header">
                          <h3 class="box-title">جدول الصور الإضافية </h3>
                          <div class="box-tools">
                          </div>
                        </div><!-- /.box-header -->
                        <div class="box-body table-responsive no-padding">
                          <table class="table table-hover">
                            ...
                            @foreach($product_images as $index=>$prod_image)
                            <tr>
                              <td>{{$index +1}}</td>
