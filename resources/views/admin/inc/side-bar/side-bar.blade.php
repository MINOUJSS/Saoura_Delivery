    ...
    <section class="sidebar">
      ...
      <li class="treeview {{active_categories_links_group()}}">
        ...
        <li class="treeview {{active_reatings_links_group()}}">
          <a href="{{route('admin.reatings')}}"><i class="fa fa-comment-dots"></i> <span>التقييمات</span> <i class="fa fa-angle-left pull-right"></i> @if(count_number_of_reatings_no_visible()!=0)<small class="label bg-red">{{count_number_of_reatings_no_visible()}}</small>@endif</a>
          <ul class="treeview-menu">
            <li class="{{active_reatings_link()}}"><a href="{{url('/admin/reatings')}}">الكل</a></li>
          </ul>
        </li>
