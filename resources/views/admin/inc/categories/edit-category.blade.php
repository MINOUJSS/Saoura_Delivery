        ...
        <h3 class="box-title">إضافة صنف</h3>
                ...
                <form role="form" action="{{route('admin.category.update')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="box-body">
                      ...
                      <input name="category" type="text" class="form-control" id="category" placeholder="أدخل إسم الصنف هنا" value="@if (old('category')!=null) {{old('category')}} @else {{$category->name}} @endif">
