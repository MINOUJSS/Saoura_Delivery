<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        تعديل علامة تجارية
        <small>تعديل علامة تجارية مميزة</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="{{route('admin.dashboard')}}"><i class="fa fa-dashboard"></i> الرئيسية</a></li>
        <li class="active">تعديل علامة تجارية</li>
      </ol>
    </section>
        ...
        <input type="hidden" name="brand_user_id" id="brand_user_id" value="{{Auth::user()->id}}">
          <div class="box-body">
            <div class="form-group {{$errors->has('brand_name')? 'has-error':''}}">
              ...
              <input type="text" class="form-control" name="brand_name" id="brand_name" placeholder="أكتب اسم العلامة التجارية" value="@if(old('brand_name'))@else {{$brand->name}}@endif">
